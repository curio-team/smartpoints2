...
<button {{ $attributes->class([
    'flex flex-row items-center justify-center cursor-pointer gap-1 rounded hover:shadow-sm active:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed',
